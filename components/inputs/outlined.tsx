    ...
    <div className="w-full">
      <div className="relative">
        <input
          ...
          onKeyDown={onKeyDown}
          id="input"
          className="-0 peer block w-full border-2 border-gray-300 bg-transparent bg-white px-2.5 pb-1.5 pt-3 text-sm text-black outline-none focus:border-orange-400 focus:ring-0"
          placeholder=""
        />
        <label
          htmlFor="input"
