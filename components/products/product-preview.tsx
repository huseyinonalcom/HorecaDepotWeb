  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          draggable={false}
          className="absolute top-2 right-2 hidden flex-col gap-2 opacity-100 duration-500 group-hover:top-2 group-hover:opacity-100 md:flex lg:top-6 lg:opacity-0"
        >
          <button
            draggable={false}
