...
export default async function getProductsAdmin(req, res) {
  ...
  try {
    ...
    fetchUrl += `populate[document_products][fields][0]=amount&populate[reservations][fields][0]=client_name&populate[reservations][fields][1]=amount&populate[reservations][fields][2]=is_deleted&populate[product_extra][fields][0]=*&populate[shelves][fields][0]=stock&fields[0]=name&populate[categories][fields][0]=localized_name&fields[2]=productLine&fields[3]=internalCode&fields[5]=value&fields[8]=description&populate[shelves][populate][supplier_order_products][fields][0]=amountOrdered&populate[shelves][populate][supplier_order_products][fields][1]=amountDelivered&fields[1]=depth&fields[4]=priceBeforeDiscount&fields[6]=width&fields[7]=height&fields[9]=material&fields[10]=color&fields[11]=imageDirections&populate[images][fields][0]=url&pagination[page]=${pageParam}${
