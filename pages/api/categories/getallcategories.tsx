...
const fetchUrl = `${process.env.API_URL}/api/categories?populate[headCategory][fields][0]=name&populate[subCategories][fields][0]=name&fields[0]=name&fields[1]=code&populate[image][fields][0]=url&sort=priority&pagination[pageSize]=100`;
