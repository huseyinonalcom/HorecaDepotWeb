...
<g:title>${sanitizeXml(prd.categories.at(0).localized_name.nl + " " + prd.name)}</g:title>
<g:description>${sanitizeXml(prd.name) + " " + sanitizeXml(prd.localized_description?.nl ?? prd.categories.map((c) => c.localized_name.nl).join(", "))}</g:description>
