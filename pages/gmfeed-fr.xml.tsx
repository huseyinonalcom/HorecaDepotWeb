...
<g:link>https://www.horecadepot.be/products/${prd.categories.at(0).localized_name.fr}/${prd.name}/${prd.id}</g:link> <g:image_link>https://hdapi.huseyinonalalpha.com${getCoverImageUrl(prd)}</g:image_link> <g:condition>new</g:condition>
