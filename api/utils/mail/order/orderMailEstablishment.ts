...
export const orderMailEstablishment = ({
  document,
}: {
  document: Document;
}) => {
                                      ...
                                      <tbody>
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                            ...
                                            <h5 class="text-teal-700" style="color: #13795b; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;" align="left">Commande sur horecadepot.be</h5>
                                            ...
                                            <p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;" align="left">Client: ${document.client.firstName + " " + document.client.lastName}</p>
                                            <p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;" align="left"><a href="https://horecadepot.be/admin/order?id=${document.id}" style="color: #13795b; text-decoration: none;">Voir la commande</a></p>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
