...
export async function getProductByID(id: number): Promise<Product> {
  const fetchUrl = `${API_URL}products/${id}?fields[0]=name&fields[1]=depth&fields[2]=productLine&fields[3]=internalCode&fields[4]=priceBeforeDiscount&fields[5]=value&fields[6]=width&fields[7]=height&fields[8]=description&fields[9]=material&fields[10]=color&fields[11]=supplierCode&fields[12]=imageDirections&fields[13]=tax&fields[14]=localized_description&populate[shelves][populate][supplier_order_products][fields][0]=amountOrdered&populate[shelves][populate][supplier_order_products][fields][1]=amountDelivered&populate[images][fields][0]=url&populate[shelves][fields][0]=stock&populate[categories][fields][0]=Name&populate[document_products][fields][0]=amount&populate[product_extra][fields][0]=*&populate[product_color][fields][0]=*`;
